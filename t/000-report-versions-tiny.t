...
eval { $v .= pmver('Dancer::Plugin::Auth::Extensible','any version') };
eval { $v .= pmver('Dancer::Plugin::Auth::Extensible::Provider::Base','any version') };
eval { $v .= pmver('Dancer::Plugin::DBIC','any version') };
eval { $v .= pmver('Dancer::Test','any version') };
eval { $v .= pmver('Module::Build','0.3601') };
eval { $v .= pmver('My::Schema','any version') };
eval { $v .= pmver('MyApp','any version') };
